...
import subprocess
subprocess.run("workon cv",shell=True)
...
np.savetxt("/home/avi/Study/Mini Project/Stability Results/xp21.txt",xp2)
np.savetxt("/home/avi/Study/Mini Project/Stability Results/yp21.txt",yp2)
